...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data">
		<dl>
 			 <dt>アカウントID<font color="red"> 必須</font></dt>
  			<dd>
				...
				<p><font color="red">* アカウントIDを入力してください</font></p>
				<?php endif; ?>
				<?php if(!empty($error['id']) && $error['id'] == 'duplicate'): ?>
				<p><font color="red">* 指定されたアカウントIDは既に使われています</font></p><?php endif; ?>
			</dd>
